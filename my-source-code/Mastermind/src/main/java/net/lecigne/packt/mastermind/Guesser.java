...
public abstract class Guesser {
    ...
    /**
     * Create a new Row object that contains a guess that matches all guesses
     * and the responses to them that are on the table.
     *
     * @return the new Row to be added to the table along with the feedback
     *         afterwards.
     */
    public Row guess() {
