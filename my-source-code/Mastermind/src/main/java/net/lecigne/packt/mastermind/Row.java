...
/**
 * One row on the table. It contains the guesses at position and also the number
 * of matching colors and position.
 */
public class Row {
    ...
    /**
     * Count the number of colors that are present on the guess but not on the
     * position where they are in the secret. If the same color is on multiple
     * position it is counted for each position once. For example the secret is
     * 
     * <pre>
     * RGRB
     * </pre>
