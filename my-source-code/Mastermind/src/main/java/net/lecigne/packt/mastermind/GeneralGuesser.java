...
public class GeneralGuesser extends Guesser {
    ...
    /**
     * Set the first possible guess. This method is used during the construction
     * process. This version just sets all colors to be the first color, since
     * in this guesser position do not need to be unique.
     */
    @Override
